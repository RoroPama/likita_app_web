...
const EventCard: React.FC<EventCardProps> = ({ event, onComment }) => {
  ...
  return (
    <div className="bg-white w-full max-w-4xl mx-auto mb-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition duration-300 overflow-hidden">
